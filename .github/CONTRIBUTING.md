...
> [!WARNING]
> Before starting to work on **feature** pull requests, **please** discuss your idea with us on the [Ideas board](https://github.com/hynek/svcs-pyramid/discussions/categories/ideas) to save you time and effort!
...
- Make sure your changes pass our [CI](https://github.com/hynek/svcs-pyramid/actions).
...
- Refer to all symbols by their fully-qualified names.
  For example, `svcs_pyramid.Foo` -- not just `Foo`.
...
- If you mention functions or methods, add parentheses at the end of their names:
  `svcs_pyramid.func()` or `svcs_pyramid.Class.method()`.
...
- Prefer simple past tense or constructions with "now".
  ...
  - `svcs_pyramid.func()` that does foo.
    It's pretty cool.
    [#1](https://github.com/hynek/svcs-pyramid/pull/1)


  ### Fixed

  - `svcs_pyramid.func()` now doesn't crash the Large Hadron Collider anymore.
    That was a nasty bug!
    [#2](https://github.com/hynek/svcs-pyramid/pull/2)
  ```
...
[llm]: https://github.com/hynek/svcs-pyramid/blob/main/.github/AI_POLICY.md
